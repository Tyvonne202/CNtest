...
class SQLDatabaseSequentialChain(Chain):
    ...
    def insert(self, table_name: str, data: dict) -> None:
        ...
        with self._engine.begin() as connection:
            ...
            stmt = sqlalchemy.insert(Table(table_name, self._metadata)).values(**data)
            # Execute statement
            connection.execute(stmt)

    def update(self, table_name: str, data: dict, condition) -> None:
        """Updates specified rows in the table."""
        with self._engine.begin() as connection:
            # Create SQL UPDATE statement
            stmt = sqlalchemy.update(Table(table_name, self._metadata)).where(condition).values(**data)
            # Execute statement
            connection.execute(stmt)
    ...
    def delete(self, table_name: str, condition) -> None:
        ...
        with self._engine.begin() as connection:
            ...
            stmt = sqlalchemy.delete(Table(table_name, self._metadata)).where(condition)
            # Execute statement
            connection.execute(stmt)
